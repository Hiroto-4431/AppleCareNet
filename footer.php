    ...
    <div class="l-footer__label">
      ...
      <div class="l-footer__contact">
        <div class="l-footer__contact__mark">
          <img src="./assets/img/common/mark-white.png" alt="">
        </div>
        <div class="l-footer__contact__content">
          ...
          <a href="#" class="l-footer__contact__date">
            <img src="./assets/img/common/tel-white.png" alt="">
            <div>
          ...
          <div class="l-footer__site__map">
            <a href="#">
              <span class="l-footer__site__map--text">
                <span class="c-text__footer__map">Google Map</span>
                <img src="./assets/img/common/window.png" alt="">
              </span>
            </a>
          </div>
        </div>
        <div class="l-footer__site__link">
          <div class="l-footer__site__list">
            ...
            <div class="l-footer__site__cell">
              ...
              <div class="l-footer__site__cell--flex">
                ...
                <div class="l-footer__site__cell--wrapper">
                  <a class="c-text__footer__link--list" href="#">待たせないLINE</a>
                  <a class="c-text__footer__link--list" href="#">テキスト確認</a>
                  <a class="c-text__footer__link--list" href="#">テキスト確認</a>
                  <a class="c-text__footer__link--list" href="#">テキスト確認</a>
                </div>
          ...
          <div class="l-footer__site__list">
            <div class="l-footer__site__cell">
              ...
              <div class="l-footer__site__cell--wrapper">
                <a class="c-text__footer__link--list" href="#">管理栄養士の導入</a>
                <a class="c-text__footer__link--list" href="#">すこやか通信</a>
                <a class="c-text__footer__link--list" href="#">栄養レシピ</a>
            ...
            <div class="l-footer__site__cell  l-footer__site__cell--last-block-margin">
              ...
              <div class="l-footer__site__cell--wrapper l-footer__site__cell--last-block-gap">
                ...
                <a class="c-text__footer__link--strong" href="#">お問い合わせ</a>
              </div>
            </div>
          </div>
        </div>
