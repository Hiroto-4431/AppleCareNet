...
<head>
  ...
  <title>アップルケアネット</title>
  <meta name="description" content="アップルケアネット" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta name="format-detection" content="telephone=no" />

  <!-- OG -->
  <meta property="og:type" content="website" />
  <meta property="og:title" content="アップルケアネット" />
  <meta property="og:description" content="アップルケアネット" />
  ...
  <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@100;300;400;500;700;900&display=sttwap" rel="stylesheet">
  ...
  <header class="l-header">
    ...
    <div class="l-header__logo">
      <a href="index.php#top">
        <img src="./assets/img/common/pc-header-logo.png" alt="">
      </a>
    </div>
      ...
      <div class="l-hmg__info">
        ...
        <div class="l-hmg__contact">
          <div class="l-hmg__contact__mark">
            <img src=" ./assets/img/common/mark.png" alt="">
          </div>
          <div class="l-hmg__contact__text">
            ...
            <a href="#" class="l-hmg__contact__mail">
