  ...
  <section class="l-content">
    <div class="l-content__wrapper">
      ...
      <div class="l-content__info">
        ...
        <div class="l-content__info__time">
          <p class="c-text__single__post">営業時間</p>
          <p class="c-text__single__post">[月～木] 9：00～17：30</p>
          <p class="c-text__single__post">[金] 9：00～18：30</p>
          <p class="c-text__single__post">[土] 8：30～10：30</p>
          <p class="c-text__single__post">[日・祝] 定休日</p>
        </div>
      </div>
      <div class="l-content__line">
        <picture>
          <source srcset="./assets/img/common/pc-store-line-base.svg" media="(min-width: 960px)" />
